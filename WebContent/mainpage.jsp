...
<div class="w3-top">
  <div class="w3-bar w3-cyan w3-card">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding-large">HOME</a>
     <a href="#" class="w3-bar-item w3-button w3-padding-large"><form method="get" action="regpg.jsp">
     <button type="submit">Sign Up</button></form></a>
      <a href="#" class="w3-bar-item w3-button w3-padding-large"><form method="get" action="loginpg.jsp">
     <button type="submit">Sign In</button></form></a>
      ...
      <div class="w3-row-padding w3-padding-32" style="margin:0 -16px">
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            ...
            <button class="w3-button w3-black w3-margin-bottom">Please LogIn</button>
          </div>
        </div>
        <div class="w3-third w3-margin-bottom">
  ...
  <div id="ticketModal" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4">
      ...
      <div class="w3-container">
        ...
        <input class="w3-input w3-border" type="text" placeholder="Whatever you wish to donate">
